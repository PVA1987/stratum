...
func main() {
	...
	flag.StringVar(&cfg.RPCServer, "spectre", cfg.RPCServer, "address of the spectred node, default `localhost:42110`")
	...
	if cfg.BlockWaitTime == 0 {
		cfg.BlockWaitTime = 5 * time.Second // this should never happen due to css 1s block times
	}
