...
import (
	...
	"github.com/spectre-network/spectred/domain/spectre/model/externalapi"
	"github.com/spectre-network/spectred/domain/spectre/utils/pow"
	"github.com/spectre-network/spectred/domain/spectre/utils/spectrehashing"
...
func (sh *shareHandler) submit(ctx *gostratum.StratumContext,
	...
	blockhash := spectrehashing.BlockHash(block)
